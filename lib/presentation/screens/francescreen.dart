...
class FranceNewsScreen extends StatefulWidget {
  final bool isEmbedded;

  const FranceNewsScreen({
    super.key,
    this.isEmbedded = false,
  });

  @override
  State<FranceNewsScreen> createState() => _FranceNewsScreenState();
}

class _FranceNewsScreenState extends State<FranceNewsScreen> {
  ...
  final List<Map<String, String>> _rssSources = [
    ...
    {'name': 'France Info', 'url': 'https://www.francetvinfo.fr/rss/tout.xml'},
  ];

  final Map<int, List<RssItemModel>> _dashboardData = {};
  bool _isLoading = true;

  // Crypto Palette (Consistent with App)
...
class _SourceBlock extends StatelessWidget {
  ...
  Color _getAccentColor(int index) {
    // Using Orange/Gold theme for consistency, but we can mix in Blue for France
    // Let's stick to the global Orange/Gold theme for the unified "Crypto" look
    final colors = [
      const Color(0xFFFF8C00), // Orange
      const Color(0xFFFFD700), // Gold
      const Color(0xFF3498DB), // Blue (France touch)
