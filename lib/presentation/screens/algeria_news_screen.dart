...
class _AlgeriaNewsScreenState extends State<AlgeriaNewsScreen> {
  ...
  final List<Map<String, String>> _rssSources = [
    ...
    },
    {
      ...
      'url': 'https://www.quotidien-oran.com/feed/'
    },

    // Arabic language sources
    {'name': 'El Khabar', 'url': 'https://elkhabar.com/feed/'},
    {'name': 'Echorouk', 'url': 'https://echoroukonline.com/feed/'},
    {'name': 'Ennahar', 'url': 'https://www.ennaharonline.com/feed/'},
...
class _SourceBlock extends StatelessWidget {
  ...
  // Palette mixing Crypto theme with Algeria flag colors
  Color _getAccentColor(int index) {
    final colors = [
      const Color(0xFFFF8C00), // Crypto Orange
      const Color(0xFFFFD700), // Crypto Gold
      const Color(0xFF006233), // Algeria Green
      const Color(0xFFD21034), // Algeria Red
