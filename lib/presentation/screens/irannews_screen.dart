...
class AppFonts {
  static bool containsArabic(String text) {
    // Covers Arabic and Persian script
    return RegExp(
            r'[\u0600-\u06FF\u0750-\u077F\u08A0-\u08FF\uFB50-\uFDFF\uFE70-\uFEFF]')
        .hasMatch(text);
  }
...
class _IranianNewsScreenState extends State<IranianNewsScreen>
  ...
  List<NewsSource> get _rssSources => NewsSources.iranian;
  ...
  Future<String> _translateText(String text, String targetMode) async {
    ...
    // Specific logic for Iranian (Persian) news:
    // Source is Persian. Target can be Arabic or English.
    final sourceLang = 'fa';
    final targetLang = targetMode == 'arabic' ? 'ar' : 'en';
                      ...
                      Text(
                        isDisabled
                            ? (_isArabicContent
                                ...
                                : 'Loading news feed...')
                            : (_isArabicContent
                                ? 'ملخص ذكي للأخبار الإيرانية'
                                : 'AI summary of Iranian events'),
                        style: AppFonts.body(
