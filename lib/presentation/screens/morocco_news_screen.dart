...
class _MoroccoNewsScreenState extends State<MoroccoNewsScreen>
  ...
  List<NewsSource> get _rssSources => NewsSources.moroccan;
  ...
  Future<String> _translateText(String text, String targetMode) async {
    ...
    // Moroccan news is mixed (French/Arabic). Use 'auto' to detect source.
                      ...
                      Text(
                        isDisabled
                            ? (_isArabicContent
                                ...
                                : 'Loading news feed...')
                            : (_isArabicContent
                                ? 'ملخص ذكي للأخبار المغربية'
                                : 'AI summary of Moroccan events'),
                        style: AppFonts.body(
