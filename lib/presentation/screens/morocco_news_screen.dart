...
class _MoroccoNewsScreenState extends State<MoroccoNewsScreen> {
  ...
  // ✅ Moroccan News Sources (Mixed French/Arabic)
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: MoroccanNewsTheme.cryptoOrange.withOpacity(0.05),
              blurRadius: 20,
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color:
                              MoroccanNewsTheme.cryptoOrange.withOpacity(0.15),
                          shape: BoxShape.circle,
                        ),
                        child: Icon(Icons.arrow_outward_rounded,
                            color: MoroccanNewsTheme.cryptoOrange, size: 18),
                      ),
                    ),
                  ],
                ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(20),
          border:
              Border.all(color: MoroccanNewsTheme.cryptoGold.withOpacity(0.1)),
        ),
        child: ClipRRect(
          borderRadius: BorderRadius.circular(20),
          child: Stack(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Icon(Icons.arrow_right_alt,
                            size: 12,
                            color:
                                MoroccanNewsTheme.cryptoGold.withOpacity(0.7)),
                      ],
                    )
                  ],
                ),
