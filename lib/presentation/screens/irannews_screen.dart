...
class _IranianNewsScreenState extends State<IranianNewsScreen> {
  ...
  Future<void> _generateDailyRecap() async {
    ...
    try {
      ...
      contextBuffer.writeln(
          'Iran News Summary - ${intl.DateFormat('EEEE, MMMM d, yyyy').format(DateTime.now())}\n');
      ...
      final String topicName = isArabic ? "إيران" : "Iran";
              ...
              children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: GoogleFonts.montserrat(
                          fontSize: 12,
                          color: IranianNewsTheme.textGrey,
                        ),
                      ),
                    ],
                  ),
                ...
                if (_isDailyRecapLoading)
                  ...
                  Icon(
                    ...
                    color: isDisabled ? Colors.white24 : Colors.teal,
                    size: 18,
                  ),
              ],
            ),
  ...
  Widget _buildDailyRecapContent() {
    final isPersian = _containsPersian(_dailyRecap ?? '');
...
class _IranianMainArticleCard extends StatefulWidget {
  final RssItemModel article;
  final bool isArabic;
  final Future<String> Function(RssItemModel) getDisplayTitle;
  final bool Function(String) containsPersian;
  final TextStyle Function(bool, TextStyle) getTextStyle;

  const _IranianMainArticleCard({
    required this.article,
    required this.isArabic,
    required this.getDisplayTitle,
    required this.containsPersian,
    required this.getTextStyle,
  });

  @override
  State<_IranianMainArticleCard> createState() =>
      _IranianMainArticleCardState();
}

class _IranianMainArticleCardState extends State<_IranianMainArticleCard>
  ...
  Widget build(BuildContext context) {
    final isMobile = ResponsiveHelper.isMobile(context);
    final bool usePersianStyle =
        widget.isArabic || widget.containsPersian(widget.article.title);
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(24),
            border: Border.all(
                color: IranianNewsTheme.cryptoOrange.withOpacity(0.2))),
        child: ClipRRect(
          borderRadius: BorderRadius.circular(24),
          child: Stack(
            children: [
              ...
              Padding(
                ...
                child: Column(
                  crossAxisAlignment: usePersianStyle
                  ...
                  children: [
                    ...
                    FutureBuilder<String>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          final isPersian = widget.containsPersian(text);
                          return Text(text,
                              ...
                              textAlign:
                                  isPersian ? TextAlign.right : TextAlign.left);
                        }),
                    if (!_isExpanded) ...[
                      const SizedBox(height: 12),
...
class _IranianSideArticleCard extends StatefulWidget {
  final RssItemModel article;
  final bool isArabic;
  final Future<String> Function(RssItemModel) getDisplayTitle;
  final bool Function(String) containsPersian;
  ...
  @override
  State<_IranianSideArticleCard> createState() =>
      _IranianSideArticleCardState();
}

class _IranianSideArticleCardState extends State<_IranianSideArticleCard>
    with SingleTickerProviderStateMixin {
  bool _isExpanded = false;
  bool _isLoading = false;
  String? _summary;
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(20),
            border: Border.all(
                color: IranianNewsTheme.cryptoGold.withOpacity(0.1))),
        child: Padding(
                ...
                children: [
                  if (!_isExpanded)
                    Icon(Icons.arrow_right_alt,
                        size: 16,
                        color: IranianNewsTheme.cryptoGold.withOpacity(0.5)),
