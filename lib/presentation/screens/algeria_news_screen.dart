  ...
  Future<void> _generateDailyRecap() async {
    ...
    try {
      ...
      contextBuffer.writeln(
          'Algeria News Summary - ${intl.DateFormat('EEEE, MMMM d, yyyy').format(DateTime.now())}\n');
      ...
      final String topicName = isArabic ? "الجزائر" : "Algeria";
              ...
              children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: GoogleFonts.montserrat(
                          fontSize: 12,
                          color: AlgerianNewsTheme.textGrey,
                        ),
                      ),
                    ],
                  ),
                ...
                if (_isDailyRecapLoading)
                  ...
                  Icon(
                    ...
                    color: isDisabled ? Colors.white24 : Colors.red,
                    size: 18,
                  ),
              ],
            ),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(20),
            border: Border.all(
                color: AlgerianNewsTheme.cryptoGold.withOpacity(0.1))),
        child: Padding(
                ...
                children: [
                  if (!_isExpanded)
                    Icon(Icons.arrow_right_alt,
                        size: 16,
                        color: AlgerianNewsTheme.cryptoGold.withOpacity(0.5)),
