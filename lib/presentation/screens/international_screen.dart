...
class AppFonts {
  ...
  // FIX: Added missing caption method
...
class _InternationalNewsScreenState extends State<InternationalNewsScreen>
  ...
  // Removed unused field: _loadingTranslations
                      ...
                      Text(
                        isDisabled
                            ? (_isArabicContent
                                ...
                                : 'Loading news feed...')
                            : (_isArabicContent
                                ? 'ملخص ذكي للأخبار العالمية'
                                : 'AI summary of global events'),
                        style: AppFonts.body(
          ...
          children: [
            Row(
              children: [
                ...
                if (items.isNotEmpty && !isLoading) _buildViewAllButton(source),
              ],
            ),
